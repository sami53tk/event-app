...
test('admin can view users list', function () {
    ...
    // Vérifier que les utilisateurs sont passés à la vue
    $response->assertViewHas('users');
    
    // Vérifier que les utilisateurs sont affichés dans la vue
...
test('admin can view user details', function () {
    ...
    // Vérifier que l'utilisateur est passé à la vue
